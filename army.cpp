...
void Army:: recruitAndTrain(Population& pop) {
    cout << "Army Recruitment & Training: \n";
    int recruitCount;
    cout << "Enter number of soldiers to recruit: ";
    cin >> recruitCount;
    if (recruitCount <= 0 || recruitCount > pop.getTotal()) {
        cout << "Invalid number of recruits.\n";
        return;
    }
    int foodRequired; 
    foodRequired = recruitCount * 2;
    ...
    soldiers =soldiers+ recruitCount;
    foodSupply =foodSupply- foodRequired;
    morale =morale+ 5;
